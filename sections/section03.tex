...
\subsection{Риманова метрика в криволинейных координатах}
...
\begin{solution}
	...
	\[
		\d x = \d(\rho\cos\varphi) = \cos\varphi\d\rho - \rho\sin\varphi\d\varphi,\quad
		\d y = \d(\rho\sin\varphi) = \sin\varphi\d\rho + \rho\cos\varphi\d\varphi,\quad
		\d z = \d h.
	\]
