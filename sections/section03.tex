...
Доказательства следующих двух утверждений аналогичны тем, что мы давали для определения Олега Ивановича.
...
Утверждение \ref{corollary:CurveOnSurface} также выполнено, причём с тем же доказательством.
...
На регулярной поверхности $\M \subset \R^3$ можно рассмотреть открытое покрытие внутренностями малых областей на этой поверхности. (В определении по И.\,А. Дынникову можно выбрать эти области гомеоморфными диску, что правильнее в смысле определения многообразия.) Согласно теореме Линделёфа\footnotemark, такая поверхность покрывается не более чем счётным набором этих областей: $\M = \bigcup_\alpha U_\alpha$, причём
...
\begin{enumerate}[nolistsep]
	...
	\item[(в)] функция $f\colon \M \to \R^m$ называется \textit{гладкой}, если в каждой карте $U_\alpha$ она задаётся как гладкая функция локальных координат $(u_\alpha^1, u_\alpha^2)$;
