...
\begin{corollary}[Формулы Родрига]
	...
	\[
		\partial_{\vec{\xi}_k}\vec{n} = -\lambda_k\vec{\xi}_k.
	\]
\end{corollary}
...
\begin{proof}
	...
	\[
		{\underbrace{\xi^i_k\vec{n}_i}_{\partial_{\vec{\xi}_k}\vec{n}}} =\joinrel= \underbrace{c^j_i\xi^i_k}_{\mathclap{-\lambda_k\xi^j_k}}\vec{r}_j = -\lambda_k\vec{\xi}_k.
	\]
